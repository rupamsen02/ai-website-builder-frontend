...
export function AccountSettings({
  ...
  return (
    <div
      className={cn("grid grid-cols-1 md:grid-cols-2 w-full  gap-4 md:gap-6", className)}
      {...props}
    >
      <div className="absolute size-80 top-40 blur-[200px] left-1/2 -z-60 sm:left-1/4 bg-primary pointer-events-none" />
      <UserProfile />
      <ChangeAvatar />
