...
export function SignUp({
  ...
  return (
    <div className="-mt-6 backdrop-blur-none md:backdrop-blur-sm min-h-screen overflow-hidden md:overflow-visible ">
      <div className="absolute w-1/2 left-1/5 top-20 size-200 pointer-events-none -z-20 bg-primary blur-[250px]" />
      <Navbar />
                ...
                <form onSubmit={handleSubmit}>
                  <FieldGroup>
                    {emailAndPassword.name !== false && (
                      <Field data-invalid={!!fieldErrors.name}>
                        ...
                        <Input
                          ...
                          className="border-primary/20! hover:border-primary! focus:ring-0!"
                        />
                    ...
                    <Field data-invalid={!!fieldErrors.password}>
                      ...
                      <InputGroup className="border-primary/20! hover:border-primary! focus-within:ring-0!">
                        <InputGroupInput
                          id="password"
                          name="password"
