...
export function ForgotPassword({ className }: ForgotPasswordProps) {
  ...
  return (
    <div className="-mt-6 backdrop-blur-none md:backdrop-blur-sm min-h-screen overflow-hidden md:overflow-visible">
      ...
      <Navbar />
      <div className="relative mx-auto flex flex-col my-30 items-center justify-center w-full max-w-5xl max-md:px-2">
        <Card className={cn("w-full max-w-sm mx-auto bg-amber-80 border border-primary", className)}>
          <CardHeader>
